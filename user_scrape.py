...
def user_ratings(username):
    ...
    while avail_results:
        ...
        url = f"https://www.beeradvocate.com/user/beers/?start={ratings_count}&ba={username}&order=ratingD&view=R"
        ...
        #  dictionary holding user stats
            ...
            if profile_table:
                ...
                profile_dict['Beer Styles:'] = ""
                profile_dict['Beers Added / Pics Uploaded:'] = ""
                profile_dict['Beers Rated / Reviewed:'] = ""
                profile_dict['US States / Countries:'] = ""
                profile_dict['Brewers:'] = ""
...
def random_forest(username):
    ...
    if flag == 1 or num_recs == 0:
        ...
        if profile_dict['Beer Styles:'] != "":
            score = "Not enough user ratings to perform prediction.  Generic recommendations provided."
        else:
            score = "Username not found.  Generic recommendations provided."
